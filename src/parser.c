...
enum {
  ...
  aux_sym_string_repeat1 = 283,
  alias_sym_keyword = 284,
  alias_sym_min_max = 285,
  alias_sym_operator = 286,
  alias_sym_separator = 287,
};
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(102)] = 1141,
  [SMALL_STATE(103)] = 1145,
  [SMALL_STATE(104)] = 1149,
  [SMALL_STATE(105)] = 1153,
  [SMALL_STATE(106)] = 1157,
  [SMALL_STATE(107)] = 1161,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [47] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(100),
  ...
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_options, 4),
  [72] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_options, 4),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ipv6, 1),
  [76] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [78] = {.entry = {.count = 1, .reusable = false}}, SHIFT(19),
  [80] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ipv6, 1),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_options, 2),
  [84] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_options, 2),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_ipv6_repeat1, 2),
  [88] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_ipv6_repeat1, 2), SHIFT_REPEAT(19),
  [91] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_ipv6_repeat1, 2),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__rule, 3),
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__rule, 3),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_options, 5),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_options, 5),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 2),
  [103] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 2),
  ...
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ipv4, 1),
  [121] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_digit, 1),
  [125] = {.entry = {.count = 1, .reusable = true}}, SHIFT(108),
  [127] = {.entry = {.count = 1, .reusable = true}}, SHIFT(84),
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_digit, 2, .production_id = 3),
  [131] = {.entry = {.count = 1, .reusable = true}}, SHIFT(102),
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__standalone_location, 2),
  ...
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_options_repeat1, 2),
  [145] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_options_repeat1, 2), SHIFT_REPEAT(58),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_port, 1),
  [150] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_location, 2),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ipv6, 2),
  ...
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_location, 3),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_digit, 3, .production_id = 4),
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 2),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_location, 4),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_location, 5),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_port, 2),
  ...
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_port, 4),
  [184] = {.entry = {.count = 1, .reusable = false}}, SHIFT(18),
  [186] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_text_repeat1, 2),
  [188] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_text_repeat1, 2), SHIFT_REPEAT(53),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_port, 5),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_port, 3),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_port, 3),
  ...
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value, 2),
  ...
  [221] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(66),
  [224] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_group_location_repeat1, 2), SHIFT_REPEAT(13),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_group_location_repeat1, 2),
  ...
  [237] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_group_port_repeat1, 2), SHIFT_REPEAT(28),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_group_port_repeat1, 2),
  ...
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_math_operator, 1),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_digit, 2),
  ...
  [260] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unit, 1),
  [262] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 2),
  [264] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_digit, 4, .production_id = 4),
  [266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hexidecimal, 2),
  [268] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_digit, 3, .production_id = 3),
  [270] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hexstring, 3),
  [272] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_options_repeat1, 2),
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3),
  [276] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [278] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__opt, 1, .production_id = 1),
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header, 6),
  [282] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value, 3),
