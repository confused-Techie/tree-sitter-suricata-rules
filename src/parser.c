  ...
  switch (state) {
    ...
    case 3:
      ...
      if (('A' <= lookahead && lookahead <= 'F') ||
          ('b' <= lookahead && lookahead <= 'f')) ADVANCE(1000);
      END_STATE();
    case 4:
      if (lookahead == '!') ADVANCE(964);
      if (lookahead == ',') ADVANCE(962);
    ...
    case 13:
      ...
      END_STATE();
    case 14:
      if (lookahead == '2') ADVANCE(949);
      END_STATE();
    case 15:
      if (lookahead == '2') ADVANCE(1127);
      if (lookahead == '3') ADVANCE(1129);
      END_STATE();
    case 16:
      if (lookahead == '3') ADVANCE(946);
      END_STATE();
    case 17:
      if (lookahead == '5') ADVANCE(950);
      END_STATE();
    case 18:
    ...
    case 910:
      ...
      END_STATE();
    case 911:
      if (lookahead == 8221) ADVANCE(1050);
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(911);
      END_STATE();
    case 912:
    ...
    case 983:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('b' <= lookahead && lookahead <= 'f')) ADVANCE(998);
      END_STATE();
    case 984:
      ACCEPT_TOKEN(sym__ipv6_octet);
      if (lookahead == ':') ADVANCE(1001);
    ...
    case 2240:
      ACCEPT_TOKEN(sym_text);
      if (lookahead == 8221) ADVANCE(1051);
      if (lookahead == '!' ||
          lookahead == '"' ||
          lookahead == '(' ||
          lookahead == ')' ||
...
static uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [2] = {
    [sym_math_operator] = STATE(52),
    [sym_digit] = STATE(63),
    [sym_digit_units] = STATE(63),
    [sym_digit_range] = STATE(63),
    ...
    [aux_sym_digit_range_token1] = ACTIONS(23),
  ...
  [5] = {
    [sym_math_operator] = STATE(44),
    [sym_digit] = STATE(64),
    [sym_digit_units] = STATE(64),
    [sym_digit_range] = STATE(64),
    [sym_hexidecimal] = STATE(64),
    [sym_hexstring] = STATE(64),
    [sym_octal] = STATE(64),
  ...
  [6] = {
    ...
    [aux_sym_digit_range_token1] = ACTIONS(33),
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(96),
  ...
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_options, 5),
  [82] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_options, 5),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__rule, 3),
  [86] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__rule, 3),
  [88] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [90] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ipv6, 1),
  [94] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [96] = {.entry = {.count = 1, .reusable = false}}, SHIFT(22),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ipv6, 1),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_options, 2),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_options, 2),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 2),
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 2),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_ipv6_repeat1, 2),
  [110] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_ipv6_repeat1, 2), SHIFT_REPEAT(22),
  [113] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_ipv6_repeat1, 2),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_options, 4),
  [117] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_options, 4),
  ...
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ipv4, 1),
  [133] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 2),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ipv4, 2),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_digit, 2, .production_id = 3),
  ...
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__standalone_location, 2),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ipv6, 2),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_location, 2),
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_digit, 1),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_location, 5),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_location, 3),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_protocol, 1),
  [163] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_protocol, 1),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_port, 2),
  [167] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_direction, 1),
  [171] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_direction, 1),
  [173] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value, 2),
  ...
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_port, 3),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_port, 5),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_port, 3),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group_port, 2),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value, 1),
  [193] = {.entry = {.count = 1, .reusable = false}}, SHIFT(16),
  [195] = {.entry = {.count = 1, .reusable = true}}, SHIFT(77),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_constant, 1),
  [199] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_math_operator, 1),
  ...
  [214] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_group_port_repeat1, 2), SHIFT_REPEAT(27),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_group_port_repeat1, 2),
  ...
  [225] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_group_location_repeat1, 2), SHIFT_REPEAT(15),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_group_location_repeat1, 2),
  [230] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [232] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [234] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [236] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_options_repeat1, 2),
  ...
  [246] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__opt, 1, .production_id = 1),
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unit, 1),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_digit_units, 2),
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hexidecimal, 2),
  [254] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_digit_units, 3, .production_id = 3),
  [256] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_octal, 2),
  [258] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hexstring, 3),
  [260] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_digit_range, 2, .production_id = 3),
  ...
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__opt, 3, .production_id = 2),
  ...
  [288] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_value, 4),
};
